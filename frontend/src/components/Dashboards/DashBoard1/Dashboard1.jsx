        ...
        <div id="wrapper">
            ...
            >
                ...
                >
                    ...
                    <div className="sidebar-brand-text mx-3" style={{fontFamily: cFontFamily}}>
                        SB Admin <sup>2</sup>
                    </div>
                </a>
                {/* Divider */}
                ...
                <li className="nav-item active">
                    <a className="nav-link" href="index.html">
                        ...
                        <span style={{fontFamily: cFontFamily}}>Dashboard</span>
                    </a>
                </li>
                {/* Divider */}
                <hr className="sidebar-divider" />
                {/* Heading */}
                <div className="sidebar-heading" style={{fontFamily: cFontFamily}}>Interface</div>
                ...
                <li className="nav-item">
                    ...
                    >
                        ...
                        <span style={{fontFamily: cFontFamily}}>Components</span>
                    </a>
                    <div
                        id="collapseTwo"
                        className="collapse"
                    ...
                    >
                        <div className="bg-white py-2 collapse-inner rounded">
                            <h6 className="collapse-header" style={{fontFamily: cFontFamily}}>Custom Components:</h6>
